...
| Another party's contracts | That party must add the querying party as an observer, or the querying party must have authorization to access that validator's Ledger API |
